...
\begin{document}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \iftoggle{inverse}{
      \draw[pattern color=lightgray, pattern=north west lines, very thin](0, 3) rectangle (1, 8);
      \draw[pattern color=lightgray, pattern=north west lines, very thin](2, 0) rectangle (3, 2);
    }
    {
    ...
    \iftoggle{inverse}{
      \draw[pattern color=lightgray, pattern=north west lines, very thin](5, 4) rectangle (6, 8);
      \draw[pattern color=lightgray, pattern=north west lines, very thin](7, 0) rectangle (8, 3);
    }{ 
    ...
    \iftoggle{inverse}{
      \draw[pattern color=lightgray, pattern=north west lines, very thin](10, 5) rectangle (11, 8);
      \draw[pattern color=lightgray, pattern=north west lines, very thin](12, 0) rectangle (13, 4);
    }{
